...
RSpec.describe Category do
  describe '#temporary_category_for' do
    ...
    context 'when a temporary category already exists' do
      let!(:temporary_category) { create(:category, profile: profile, name: 'Temporary', color: '#808080') }
    ...
    context 'when a temporary category already exists but for another profile' do
      ...
      let!(:temporary_category) { create(:category, profile: profile2, name: 'Temporary', color: '#808080') }
